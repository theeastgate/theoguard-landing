        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-[36ch] mb-6">
              AI-powered theological analysis for pastors and church leaders. Upload content,
              receive a doctrinal soundness report.
            </p>
            <a
              href="https://app.theoguard.com"
              className="inline-flex items-center gap-2 px-4 py-2 bg-amber-700 hover:bg-amber-600 text-white text-sm font-medium rounded-lg transition-colors duration-150"
            >
              Start free
            </a>
          </div>
